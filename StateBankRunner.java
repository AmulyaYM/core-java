class StateBankRunner {
    ...
    public static void main(String branches[]) {

        StateBank branch = new StateBank();
        branch.ifscCode = "SBIN0009044";
        branch.address = "MG Road, Bengaluru";
        branch.district = "Bangalore";
        branch.state = "Karnataka";
        branch.branch = "MG Road";
        branch.phoneNumber = 8025584000L;

        System.out.println("State Bank of India details with different branches:");

        System.out.println("IFSC code: " + branch.ifscCode);
        System.out.println("Address: " + branch.address);
        System.out.println("District: " + branch.district);
        System.out.println("State: " + branch.state);
        System.out.println("Branch name: " + branch.branch);
        System.out.println("Phone number: " + branch.phoneNumber);

        StateBank branch1 = new StateBank();
        branch1.ifscCode = "SBIN0040015";
        branch1.address = "Jayanagar 4th Block, Bengaluru";
        branch1.district = "Bangalore";
        branch1.state = "Karnataka";
        branch1.branch = "Jayanagar";
        branch1.phoneNumber = 8026585001L;
        ...
        System.out.println("Branch name: " + branch1.branch);
        System.out.println("Phone number: " + branch1.phoneNumber);

        StateBank branch2 = new StateBank();
        branch2.ifscCode = "SBIN0040100";
        branch2.address = "Indiranagar 100 Feet Road, Bengaluru";
        branch2.district = "Bangalore";
        branch2.state = "Karnataka";
        branch2.branch = "Indiranagar";
        branch2.phoneNumber = 8025287002L;
        ...
        System.out.println("Branch name: " + branch2.branch);
        System.out.println("Phone number: " + branch2.phoneNumber);

        StateBank branch3 = new StateBank();
        branch3.ifscCode = "SBIN0040022";
        branch3.address = "Koramangala 5th Block, Bengaluru";
        branch3.district = "Bangalore";
        branch3.state = "Karnataka";
        branch3.branch = "Koramangala";
        branch3.phoneNumber = 8025587003L;
        ...
        System.out.println("Branch name: " + branch3.branch);
        System.out.println("Phone number: " + branch3.phoneNumber);

        StateBank branch4 = new StateBank();
        branch4.ifscCode = "SBIN0040048";
        branch4.address = "Rajajinagar, Bengaluru";
        branch4.district = "Bangalore";
        branch4.state = "Karnataka";
        branch4.branch = "Rajajinagar";
        branch4.phoneNumber = 8023387004L;
        ...
        System.out.println("Branch name: " + branch4.branch);
        System.out.println("Phone number: " + branch4.phoneNumber);

        StateBank branch5 = new StateBank();
        branch5.ifscCode = "SBIN0040056";
        branch5.address = "Malleshwaram, Bengaluru";
        branch5.district = "Bangalore";
        branch5.state = "Karnataka";
        branch5.branch = "Malleshwaram";
        branch5.phoneNumber = 8023487005L;
        ...
        System.out.println("Branch name: " + branch5.branch);
        System.out.println("Phone number: " + branch5.phoneNumber);

        StateBank branch6 = new StateBank();
        branch6.ifscCode = "SBIN0040063";
        branch6.address = "Banashankari 2nd Stage, Bengaluru";
        branch6.district = "Bangalore";
        branch6.state = "Karnataka";
        branch6.branch = "Banashankari";
        branch6.phoneNumber = 8026787006L;
        ...
        System.out.println("Branch name: " + branch6.branch);
        System.out.println("Phone number: " + branch6.phoneNumber);

        StateBank branch7 = new StateBank();
        branch7.ifscCode = "SBIN0040071";
        branch7.address = "BTM Layout, Bengaluru";
        branch7.district = "Bangalore";
        branch7.state = "Karnataka";
        branch7.branch = "BTM Layout";
        branch7.phoneNumber = 8026887007L;
        ...
        System.out.println("Branch name: " + branch7.branch);
        System.out.println("Phone number: " + branch7.phoneNumber);

        StateBank branch8 = new StateBank();
        branch8.ifscCode = "SBIN0040089";
        branch8.address = "Whitefield Main Road, Bengaluru";
        branch8.district = "Bangalore";
        branch8.state = "Karnataka";
        branch8.branch = "Whitefield";
        branch8.phoneNumber = 8026987008L;
        ...
        System.out.println("Branch name: " + branch8.branch);
        System.out.println("Phone number: " + branch8.phoneNumber);

        StateBank branch9 = new StateBank();
        branch9.ifscCode = "SBIN0040097";
        branch9.address = "Electronic City Phase 1, Bengaluru";
        branch9.district = "Bangalore";
        branch9.state = "Karnataka";
        branch9.branch = "Electronic City";
        branch9.phoneNumber = 8027087009L;
        ...
        System.out.println("Branch name: " + branch9.branch);
